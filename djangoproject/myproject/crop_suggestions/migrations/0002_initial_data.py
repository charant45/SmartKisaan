...
def create_initial_data(apps, schema_editor):
    CropSuggestion = apps.get_model('crop_suggestions', 'CropSuggestion')
    
    # Sample data with 25 crop suggestions
    crops = [
        # Summer Crops
        {
            'season': 'Summer', 
        ...
        },
        {
            ...
            'soil_type': 'Sandy Loam',
            'crop_name': 'Lemon',
            'description': 'Lemon is a citrus fruit that can be grown year-round in tropical and subtropical regions.',
            'planting_method': 'Plant grafted saplings 4-5 m apart.',
            'water_requirements': 'Medium',
            'growth_duration': '2-3 years to first fruit, productive for 25+ years'
        },
    ]
